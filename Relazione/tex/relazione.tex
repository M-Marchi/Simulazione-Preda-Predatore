...
Per questa ragione l'idea è stata quella di reinserire ad ogni cambio stagione un numero proporzionale rispetto al numero iniziale di animali (30 conigli e 10 volpi) %con parametri uguali al valore medio dei parametri degli animali visualizzati nella simulazione. Questo perché si assume che 
